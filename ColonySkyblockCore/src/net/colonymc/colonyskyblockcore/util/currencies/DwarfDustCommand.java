...
public class DwarfDustCommand implements CommandExecutor {
	...
	String usage = ChatColor.translateAlternateColorCodes('&', " &5&l» &fUsage: &d/dwarfdust give/take/set <player> <amount>");
	String youHave = ChatColor.translateAlternateColorCodes('&', " &5&l» &fYou currently have &d");
	String invalidNumber = ChatColor.translateAlternateColorCodes('&', " &5&l» &cPlease enter a valid number!");
	String nerverJoined = ChatColor.translateAlternateColorCodes('&', " &5&l» &fThis player has never joined the server!");
	String numberBiggerThanZero = ChatColor.translateAlternateColorCodes('&', " &5&l» &cPlease enter a number bigger than 0!");
