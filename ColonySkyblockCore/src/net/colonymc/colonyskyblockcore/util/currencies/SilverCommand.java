...
public class SilverCommand implements CommandExecutor {
	...
	String usage = ChatColor.translateAlternateColorCodes('&', " &5&l» &fUsage: &d/balance give/take/set <player> <amount>");
	...
	String nerverJoined = ChatColor.translateAlternateColorCodes('&', " &5&l» &fThis player is not online!");
