...
public class Auction {
	...
	public static ArrayList<Auction> activeAuctions = new ArrayList<Auction>();
	...
	public void removeBidder(Bidder b) {
		bidders.remove(bidders.indexOf(b));
	...
	public void shouldDelete() {
		...
		if(shouldDelete) {
			activeAuctions.remove(activeAuctions.indexOf(this));
